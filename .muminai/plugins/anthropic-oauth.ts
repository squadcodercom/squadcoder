/**
 * MuminAI — OPTIONAL Claude Pro/Max subscription login (opt-in, at your own risk).
 *
 ...
 *
 * This is NOT enabled by default. To enable, add to `.muminai/muminai.json`:
...
export const id = "muminai-anthropic-oauth"
export { server }

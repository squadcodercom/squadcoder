...
Puede agregar comandos personalizados a través de la configuración SquadCoder o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su SquadCoder [config](/docs/config):

...
Con SquadCoder puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, SquadCoder usa nuestro propio tema `opencode`.
...
SquadCoder viene con varios temas integrados.
...
- Quiere que SquadCoder coincida con la apariencia de su terminal
...
SquadCoder admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.

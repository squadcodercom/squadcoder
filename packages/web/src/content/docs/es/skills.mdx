...
Las habilidades del agente permiten a SquadCoder descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
SquadCoder busca estas ubicaciones:
...
Para las rutas locales del proyecto, SquadCoder sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
...
SquadCoder enumera las habilidades disponibles en la descripción de la herramienta `skill`.

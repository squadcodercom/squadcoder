---
title: Compartir
description: Comparte tus conversaciones SquadCoder.
---

La función para compartir de SquadCoder te permite crear enlaces públicos a tus conversaciones de SquadCoder, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, SquadCoder:
...
SquadCoder admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, SquadCoder usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:

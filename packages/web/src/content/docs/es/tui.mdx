---
title: TUI
description: Usando la interfaz de usuario del terminal SquadCoder.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

SquadCoder proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar SquadCoder se inicia TUI para el directorio actual.
...
Cuando utilice SquadCoder TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a SquadCoder. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de SquadCoder. _Alias_: `/quit`, `/q`

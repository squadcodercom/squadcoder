---
title: Share
description: Share your SquadCoder conversations.
---

SquadCoder's share feature allows you to create public links to your SquadCoder conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, SquadCoder:
...
SquadCoder supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, SquadCoder uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:

...
You can add custom commands through the SquadCoder config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your SquadCoder [config](/docs/config):

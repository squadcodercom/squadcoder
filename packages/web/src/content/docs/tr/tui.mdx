---
title: TUI
description: SquadCoder terminal kullanıcı arayüzünü kullanma.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

SquadCoder, projelerinizde LLM ile çalışmak için etkileşimli bir terminal arayüzü (TUI) sunar.

SquadCoder'u çalıştırdığınızda mevcut dizin için TUI başlar.
...
SquadCoder TUI kullanırken `/` ve ardından komut adını yazarak hızlı eylemler çalıştırabilirsiniz. Örneğin:
...
SquadCoder'a bir sağlayıcı ekler. Mevcut sağlayıcıları seçip API anahtarları eklemenizi sağlar.
...
SquadCoder'dan çıkar. _Takma adlar_: `/quit`, `/q`

---
title: Zen
description: Utvalgt liste over modeller levert av SquadCoder.
---
...
SquadCoder Zen er en liste over testede og verifiserte modeller levert av SquadCoder-teamet.

:::note
SquadCoder Zen er for øyeblikket i beta.
:::

Zen fungerer som enhver annen leverandør i SquadCoder. Du logger inn på SquadCoder Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med SquadCoder.
:::
...
SquadCoder Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

SquadCoder Zen fungerer som enhver annen leverandør i SquadCoder.

1. Du logger inn på **<a href={console}>SquadCoder Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger SquadCoder Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i SquadCoder-konfigurasjonen din
...
- MiniMax M2.5 Free er tilgjengelig på SquadCoder i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Super Free er tilgjengelig på SquadCoder i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på SquadCoder i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
Vi opprettet SquadCoder Zen for å:
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med SquadCoder også.

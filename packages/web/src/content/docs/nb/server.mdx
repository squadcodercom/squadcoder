---
title: Tjener
description: Samhandle med SquadCoder-tjener over HTTP.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Kommandoen `opencode serve` kjører en hodeløs HTTP-server som eksponerer et OpenAPI-endepunkt som en SquadCoder-klient kan bruke.
...
:::tip
Bruk SquadCoder-serveren til å samhandle med SquadCoder programmatisk.
:::

Denne arkitekturen lar SquadCoder støtte flere klienter og lar deg samhandle med SquadCoder programmatisk.

Du kan kjøre `opencode serve` for å starte en frittstående server. Hvis du har
SquadCoder TUI kjører, vil `opencode serve` starte en ny server.
...
[`/tui`](#tui) endepunktet kan brukes til å kjøre TUI gjennom serveren. Du kan for eksempel forhåndsutfylle eller kjøre en forespørsel. Dette oppsettet brukes av SquadCoder [IDE](/docs/ide) plugins.

---
title: SDK
description: Typesikker JS-klient for SquadCoder-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

SquadCoder JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere SquadCoder programmatisk.
...
Opprett en forekomst av SquadCoder:
...
Hvis du allerede har en kjørende forekomst av SquadCoder, kan du opprette en klientforekomst for å koble til den:

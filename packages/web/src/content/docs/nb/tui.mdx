...
SquadCoder gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre SquadCoder starter TUI for gjeldende katalog.
...
Når du bruker SquadCoder TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til SquadCoder. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt SquadCoder. _Aliaser_: `/quit`, `/q`

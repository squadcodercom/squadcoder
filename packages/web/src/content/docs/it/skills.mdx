...
Le skill degli agenti permettono a SquadCoder di individuare istruzioni riutilizzabili dal tuo repo o dalla home directory.
...
SquadCoder cerca in queste posizioni:
...
Per i percorsi locali al progetto, SquadCoder risale dalla directory di lavoro corrente finche' non raggiunge il worktree git.
...
SquadCoder elenca le skill disponibili nella descrizione dello strumento `skill`.

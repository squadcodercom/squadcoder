...
Con SquadCoder puoi scegliere tra diversi temi integrati, usare un tema che si adatta al tema del tuo terminale oppure definire un tema personalizzato.

Per impostazione predefinita, SquadCoder usa il tema `opencode`.
...
SquadCoder include diversi temi integrati.
...
- Vuole che SquadCoder corrisponda all'aspetto del terminale
...
SquadCoder supporta un sistema di temi flessibile basato su JSON che permette di creare e personalizzare temi facilmente.

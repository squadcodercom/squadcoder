---
title: Zen
description: Lista curata di modelli fornita da SquadCoder.
---
...
SquadCoder Zen è un elenco di modelli testati e verificati forniti dal team di SquadCoder.

:::note
SquadCoder Zen è attualmente in beta.
:::

Zen funziona come qualsiasi altro provider in SquadCoder. Accedi a SquadCoder Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con SquadCoder.
:::
...
SquadCoder Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

SquadCoder Zen funziona come qualsiasi altro provider in SquadCoder.

1. Accedi a **<a href={console}>SquadCoder Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona SquadCoder Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di SquadCoder
...
- MiniMax M2.5 Free è disponibile su SquadCoder per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Super Free è disponibile su SquadCoder per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su SquadCoder per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato SquadCoder Zen per:
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con SquadCoder.

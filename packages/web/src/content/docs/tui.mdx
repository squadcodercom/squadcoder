---
title: TUI
description: Using the SquadCoder terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

SquadCoder provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running SquadCoder starts the TUI for the current directory.
...
When using the SquadCoder TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to SquadCoder. Allows you to select from available providers and add their API keys.
...
Exit SquadCoder. _Aliases_: `/quit`, `/q`

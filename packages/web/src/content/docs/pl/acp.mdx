---
title: ACP
description: Używanie SquadCoder z protokołem Agent Client Protocol (ACP).
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

SquadCoder obsługuje [Agent Client Protocol](https://agentclientprotocol.com) (ACP), który umożliwia korzystanie z SquadCoder bezpośrednio w edytorach i środowiskach IDE.
...
Aby używać SquadCoder przez ACP, skonfiguruj swój edytor tak, aby uruchamiał polecenie `opencode acp`.

Uruchamia to SquadCoder jako podproces zgodny z ACP, który komunikuje się z edytorem za pomocą JSON-RPC przez stdio.
...
Następnie wybierz „SquadCoder” w selektorze agentów AI Chat.
...
Aby używać SquadCoder jako agenta ACP w [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodaj następującą konfigurację do Neovim:
...
Ta konfiguracja sprawia, że CodeCompanion używa SquadCoder jako agenta ACP do czatu.
...
SquadCoder działa przez ACP tak samo, jak w terminalu. Obsługiwane są wszystkie główne funkcje:
...
- Serwery MCP zdefiniowane w konfiguracji SquadCoder

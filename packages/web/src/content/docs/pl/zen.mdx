---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez SquadCoder.
---
...
SquadCoder Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół SquadCoder.

:::note
SquadCoder Zen jest obecnie w wersji beta.
:::

Zen działa jak każdy inny dostawca w SquadCoder. Logujesz się do SquadCoder Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z SquadCoder.
:::
...
SquadCoder Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

SquadCoder Zen działa jak każdy inny dostawca w SquadCoder.

1. Logujesz się do **<a href={console}>SquadCoder Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz SquadCoder Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji SquadCoder używa formatu
...
- MiniMax M2.5 Free jest dostępny w SquadCoder przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Super Free jest dostępny w SquadCoder przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w SquadCoder przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
Stworzyliśmy SquadCoder Zen, aby:
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w SquadCoder także dowolnego innego dostawcy.

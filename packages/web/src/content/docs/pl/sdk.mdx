---
title: SDK
description: Typowany klient JS dla serwera SquadCoder.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Pakiet SDK JS/TS SquadCoder zapewnia klienta z bezpiecznym typowaniem (type-safe) do interakcji z serwerem.
Użyj go do budowania integracji i programowej kontroli SquadCoder.
...
Utwórz instancję SquadCoder:

```javascript
import { createOpencode } from "@squadcoder/sdk"
...
Jeśli masz już działającą instancję SquadCoder, możesz utworzyć instancję klienta, aby się z nią połączyć:
...
```typescript
import type { Session, Message, Part } from "@squadcoder/sdk"
```

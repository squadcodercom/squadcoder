---
title: Zen
description: Lista selecionada de modelos fornecidos pelo SquadCoder.
---
...
O SquadCoder Zen é uma lista de modelos testados e verificados fornecidos pela equipe do SquadCoder.

:::note
O SquadCoder Zen está atualmente em beta.
:::

O Zen funciona como qualquer outro provedor no SquadCoder. Você faz login no SquadCoder Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o SquadCoder.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o SquadCoder.
:::
...
O SquadCoder Zen é um gateway de AI que dá a você acesso a esses modelos.

---

## Como funciona

O SquadCoder Zen funciona como qualquer outro provedor no SquadCoder.

1. Você faz login no **<a href={console}>SquadCoder Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona SquadCoder Zen e cola sua chave de API.
...
O [model id](/docs/config/#models) na sua configuração do SquadCoder usa o formato `opencode/<model-id>`. Por exemplo, para GPT 5.3 Codex, você usaria `opencode/gpt-5.3-codex` na sua configuração.
...
- MiniMax M2.5 Free está disponível no SquadCoder por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3 Super Free está disponível no SquadCoder por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo stealth que está gratuito no SquadCoder por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
4. Não ter **lock-in**, permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o SquadCoder também.

...
Agentferdigheter lar SquadCoder oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
SquadCoder søker etter disse stedene:
...
For prosjektlokale stier går SquadCoder opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
SquadCoder viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.

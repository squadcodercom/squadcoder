---
title: Zen
description: Udvalgt liste over modeller leveret af SquadCoder.
---
...
SquadCoder Zen er en liste over testede og verificerede modeller leveret af SquadCoder-teamet.

:::note
SquadCoder Zen er i øjeblikket i beta.
:::

Zen fungerer som enhver anden udbyder i SquadCoder. Du logger ind på SquadCoder Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med SquadCoder.
:::
...
SquadCoder Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

SquadCoder Zen fungerer som enhver anden udbyder i SquadCoder.

1. Du logger ind på **<a href={console}>SquadCoder Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger SquadCoder Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din SquadCoder-konfiguration
...
- MiniMax M2.5 Free er tilgængelig på SquadCoder i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Super Free er tilgængelig på SquadCoder i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på SquadCoder i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
Vi skabte SquadCoder Zen for at:
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med SquadCoder også.

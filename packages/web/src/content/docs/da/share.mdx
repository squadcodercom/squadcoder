---
title: Deling
description: Del dine SquadCoder-samtaler.
---

SquadCoders delingsfunksjon lar deg lage offentlige lenker til dine SquadCoder-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, SquadCoder:
...
SquadCoder støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger SquadCoder manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:

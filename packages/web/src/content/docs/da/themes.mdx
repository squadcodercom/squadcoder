...
Med SquadCoder kan du velge fra ett av flere innebygde temaer, bruge et tema som tilpasser seg terminaltemaet ditt, eller definere ditt eget tilpassede tema.

Som standard bruger SquadCoder vårt eget `opencode`-tema.
...
SquadCoder kommer med flere innebygde temaer.
...
- Vil at SquadCoder skal matche terminalens utseende
...
SquadCoder støtter et fleksibelt JSON-basert temasystem som lar brugere enkelt lage og tilpasse temaer.

---
title: TUI
description: Brug af SquadCoder-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

SquadCoder giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre SquadCoder starter TUI for den nuværende mappe.
...
Når du bruger SquadCoder TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til SquadCoder. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut SquadCoder. _Aliaser_: `/quit`, `/q`

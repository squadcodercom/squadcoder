...
Agent skills let SquadCoder discover reusable instructions from your repo or home directory.
...
SquadCoder searches these locations:
...
For project-local paths, SquadCoder walks up from your current working directory until it reaches the git worktree.
...
SquadCoder lists available skills in the `skill` tool description.

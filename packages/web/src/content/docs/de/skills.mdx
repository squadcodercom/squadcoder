...
Agent Skills erlauben SquadCoder, wiederverwendbare Anweisungen aus deinem Repo oder Home-Verzeichnis zu finden.
...
SquadCoder sucht in folgenden Pfaden:
...
Bei projektlokalen Pfaden laeuft SquadCoder vom aktuellen Verzeichnis nach oben bis zum Git-Worktree.
...
SquadCoder listet verfuegbare Skills in der Beschreibung des `skill`-Tools.

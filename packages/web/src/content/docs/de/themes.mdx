...
Mit SquadCoder kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet SquadCoder das `opencode`-Theme.
...
SquadCoder liefert mehrere eingebaute Themes mit.
...
- SquadCoder optisch ans Terminal anpassen wollen
...
SquadCoder unterstuetzt ein flexibles JSON-basiertes Theme-System.

---
title: LSP Server
description: SquadCoder lässt sich in Ihren LSP-Server integrieren.
---

SquadCoder lässt sich in Ihr Language Server Protocol (LSP) integrieren, um die Interaktion von LLM mit Ihrer Codebasis zu unterstützen. Es verwendet Diagnosefunktionen, um dem LLM Feedback zu geben.

---

## Integriert

SquadCoder verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn SquadCoder eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer SquadCoder-Konfiguration anpassen.

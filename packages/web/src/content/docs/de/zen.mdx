---
title: Zen
description: Kuratierte Modellliste direkt von SquadCoder.
---
...
SquadCoder Zen ist eine Liste von getesteten und verifizierten Modellen, die vom SquadCoder-Team bereitgestellt wird.

:::note
SquadCoder Zen befindet sich derzeit in der Beta.
:::

Zen funktioniert wie jeder andere Provider in SquadCoder. Du meldest dich bei SquadCoder Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um SquadCoder zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit SquadCoder funktionieren.
:::
...
SquadCoder Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

SquadCoder Zen funktioniert wie jeder andere Provider in SquadCoder.

1. Du meldest dich bei **<a href={console}>SquadCoder Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst SquadCoder Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner SquadCoder-Konfiguration verwendet das Format `opencode/<model-id>`. Für GPT 5.3 Codex würdest du zum Beispiel `opencode/gpt-5.3-codex` in deiner Konfiguration verwenden.
...
- MiniMax M2.5 Free ist für begrenzte Zeit auf SquadCoder verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Super Free ist für begrenzte Zeit auf SquadCoder verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf SquadCoder verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben SquadCoder Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit SquadCoder auch jeden anderen Provider zu verwenden.

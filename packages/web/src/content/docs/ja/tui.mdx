---
title: TUI
description: SquadCoder ターミナルユーザーインターフェイスの使用。
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

SquadCoder は、LLM を使用してプロジェクトを作業するための対話型ターミナルインターフェイスまたは TUI を提供します。

SquadCoder を実行すると、現在のディレクトリの TUI が開始されます。
...
SquadCoder TUI を使用する場合、「`/`」に続いてコマンド名を入力すると、アクションをすばやく実行できます。例えば：
...
SquadCoder にプロバイダーを追加します。利用可能なプロバイダーから選択し、その API キーを追加できます。
...
SquadCoder を終了します。 _エイリアス_: `/quit`、`/q`

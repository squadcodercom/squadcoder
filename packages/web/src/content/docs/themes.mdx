...
With SquadCoder you can select from one of several built-in themes, use a theme that adapts to your terminal theme, or define your own custom theme.

By default, SquadCoder uses our own `opencode` theme.
...
SquadCoder comes with several built-in themes.
...
- Want SquadCoder to match their terminal's appearance
...
SquadCoder supports a flexible JSON-based theme system that allows users to create and customize themes easily.

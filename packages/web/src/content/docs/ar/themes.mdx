...
مع SquadCoder يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم SquadCoder سمتنا `opencode`.
...
يأتي SquadCoder مع عدة سمات مدمجة.
...
- يريدون أن يطابق SquadCoder مظهر terminal لديهم
...
يدعم SquadCoder نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.

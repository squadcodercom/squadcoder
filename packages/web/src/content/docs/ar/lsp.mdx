---
title: خوادم LSP
description: يتكامل SquadCoder مع خوادم LSP لديك.
---

يتكامل SquadCoder مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي SquadCoder مع عدة خوادم LSP مدمجة للغات الشائعة:

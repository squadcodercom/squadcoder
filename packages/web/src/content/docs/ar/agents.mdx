...
يوجد نوعان من الوكلاء في SquadCoder: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي SquadCoder مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي SquadCoder مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي SquadCoder مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
إذا لم يتم تحديد temperature، يستخدم SquadCoder القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات SquadCoder العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات SquadCoder الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [SquadCoder Zen](/docs/zen)، فستستخدم `opencode/gpt-5.1-codex` لـ GPT 5.1 Codex.

---
title: Zen
description: قائمة منتقاة من النماذج يوفّرها SquadCoder.
---
...
SquadCoder Zen هي قائمة بالنماذج التي اختبرها فريق SquadCoder وتحقّق منها.

:::note
SquadCoder Zen متاح حاليا بنسخة تجريبية.
:::

يعمل Zen مثل أي مزوّد آخر في SquadCoder. تسجّل الدخول إلى SquadCoder Zen وتحصل على
مفتاح API. استخدامه **اختياري بالكامل** ولا تحتاج إليه لاستخدام SquadCoder.
...
:::tip
اختبرنا مجموعة منتقاة من النماذج والمزوّدين الذين يعملون جيدا مع SquadCoder.
:::
...
SquadCoder Zen هي بوابة AI تتيح لك الوصول إلى هذه النماذج.

---

## كيف يعمل

يعمل SquadCoder Zen مثل أي مزوّد آخر في SquadCoder.

1. تسجّل الدخول إلى **<a href={console}>SquadCoder Zen</a>**، وتضيف تفاصيل الفوترة، ثم تنسخ مفتاح API.
2. تشغّل الأمر `/connect` في واجهة TUI، وتختار SquadCoder Zen، ثم تلصق مفتاح API.
...
يستخدم [معرّف النموذج](/docs/config/#models) في إعدادات SquadCoder الصيغة `opencode/<model-id>`. على سبيل المثال، بالنسبة إلى GPT 5.3 Codex، ستستخدم `opencode/gpt-5.3-codex` في إعداداتك.
...
- MiniMax M2.5 Free متاح على SquadCoder لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- Nemotron 3 Super Free متاح على SquadCoder لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- Big Pickle نموذج خفي ومتاح مجانا على SquadCoder لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
...
4. **عدم فرض أي ارتباط حصري** عبر تمكينك من استخدامه مع أي عامل برمجة آخر. ومع إبقاء إمكانية استخدام أي مزوّد آخر مع SquadCoder أيضا دائما.

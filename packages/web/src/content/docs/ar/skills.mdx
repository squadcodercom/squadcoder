...
تتيح مهارات الوكيل لـ SquadCoder اكتشاف تعليمات قابلة لإعادة الاستخدام من مستودعك أو من دليل المنزل.
...
يبحث SquadCoder في هذه المواقع:
...
بالنسبة لمسارات المشروع المحلية، يتدرج SquadCoder صعوداً من دليل العمل الحالي حتى يصل إلى `git worktree`.
...
يعرض SquadCoder المهارات المتاحة في وصف أداة `skill`.

---
title: LSP Servers
description: SquadCoder integrates with your LSP servers.
---

SquadCoder integrates with your Language Server Protocol (LSP) to help the LLM interact with your codebase. It uses diagnostics to provide feedback to the LLM.

---

## Built-in

SquadCoder comes with several built-in LSP servers for popular languages:

...
Agent skills omogucavaju SquadCoder da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
SquadCoder pretrazuje ove lokacije:
...
Za projektne lokalne putanje, SquadCoder ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
...
SquadCoder navodi dostupne skills u opisu `skill` alata.

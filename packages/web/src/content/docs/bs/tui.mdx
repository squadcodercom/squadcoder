---
title: TUI
description: Korištenje korisničkog interfejsa SquadCoder terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

SquadCoder pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje SquadCoder pokreće TUI za trenutni direktorij.
...
Kada koristite SquadCoder TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u SquadCoder. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz SquadCoder. _Aliases_: `/quit`, `/q`

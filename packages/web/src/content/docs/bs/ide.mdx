---
title: IDE
description: Ekstenzija SquadCoder za VS Code, Cursor i druge IDE
---

SquadCoder se integriše sa VS kodom, Cursor-om ili bilo kojim IDE-om koji podržava terminal. Samo pokrenite `opencode` u terminalu da započnete.

---

## Korištenje

- **Brzo pokretanje**: Koristite `Cmd+Esc` (Mac) ili `Ctrl+Esc` (Windows/Linux) da otvorite SquadCoder u prikazu podijeljenog terminala ili fokusirajte postojeću terminalsku sesiju ako je već pokrenuta.
- **Nova sesija**: Koristite `Cmd+Shift+Esc` (Mac) ili `Ctrl+Shift+Esc` (Windows/Linux) da započnete novu SquadCoder terminalsku sesiju, čak i ako je ona već otvorena. Takođe možete kliknuti na dugme SquadCoder u korisničkom sučelju.
- **Svijest o kontekstu**: Automatski dijelite svoj trenutni odabir ili karticu s SquadCoder.
...
Da biste instalirali SquadCoder na VS Code i popularne viljuške kao što su Cursor, Windsurf, VSCodium:
...
Potražite **SquadCoder** na Extension Marketplaceu i kliknite na **Instaliraj**.

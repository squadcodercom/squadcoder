...
U SquadCoder mozete birati izmedu vise ugradenih tema, koristiti temu koja se prilagodava terminalu ili definisati vlastitu temu.

Po defaultu, SquadCoder koristi nasu `opencode` temu.
...
SquadCoder dolazi sa vise ugradenih tema.
...
- Zele da SquadCoder odgovara izgledu njihovog terminala
...
SquadCoder podrzava fleksibilan sistem tema baziran na JSON-u koji olaksava kreiranje i prilagodavanje tema.

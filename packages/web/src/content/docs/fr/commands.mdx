...
Vous pouvez ajouter des commandes personnalisées via la configuration SquadCoder ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre SquadCoder [config](/docs/config) :

...
Les compétences d'agent permettent à SquadCoder de découvrir des instructions réutilisables à partir de votre dépôt ou de votre répertoire personnel.
...
SquadCoder recherche ces emplacements :
...
Pour les chemins locaux du projet, SquadCoder remonte de votre répertoire de travail actuel jusqu'à ce qu'il atteigne l'arbre de travail git.
...
SquadCoder répertorie les compétences disponibles dans la description de l'outil `skill`.

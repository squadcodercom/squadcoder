---
title: Zen
description: Liste organisée de modèles fournis par SquadCoder.
---
...
SquadCoder Zen est une liste de modèles testés et vérifiés fournie par l'équipe SquadCoder.

:::note
SquadCoder Zen est actuellement en version bêta.
:::

Zen fonctionne comme n'importe quel autre fournisseur dans SquadCoder. Vous vous connectez à SquadCoder Zen et obtenez votre clé API. C'est **entièrement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser SquadCoder.
...
:::tip
Nous avons testé un groupe sélectionné de modèles et de fournisseurs qui fonctionnent bien avec SquadCoder.
:::
...
SquadCoder Zen est une passerelle AI qui vous donne accès à ces modèles.

---

## Comment ça marche

SquadCoder Zen fonctionne comme n'importe quel autre fournisseur dans SquadCoder.

1. Vous vous connectez à **<a href={console}>SquadCoder Zen</a>**, ajoutez vos informations de facturation et copiez votre clé API.
2. Vous exécutez la commande `/connect` dans le TUI, sélectionnez SquadCoder Zen et collez votre clé API.
...
Le [model id](/docs/config/#models) dans votre configuration SquadCoder utilise le format `opencode/<model-id>`. Par exemple, pour GPT 5.3 Codex, vous utiliseriez `opencode/gpt-5.3-codex` dans votre configuration.
...
- MiniMax M2.5 Free est disponible sur SquadCoder pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Nemotron 3 Super Free est disponible sur SquadCoder pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Big Pickle est un modèle stealth gratuit sur SquadCoder pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
...
Nous avons créé SquadCoder Zen pour :
...
4. N'avoir **aucun lock-in** en vous permettant de l'utiliser avec n'importe quel autre agent de codage. Et toujours vous permettre d'utiliser n'importe quel autre fournisseur avec SquadCoder également.

---
title: Zen
description: Curated list of models provided by SquadCoder.
---
...
SquadCoder Zen is a list of tested and verified models provided by the SquadCoder team.

:::note
SquadCoder Zen is currently in beta.
:::

Zen works like any other provider in SquadCoder. You login to SquadCoder Zen and get
...
:::tip
We tested a select group of models and providers that work well with SquadCoder.
:::
...
SquadCoder Zen is an AI gateway that gives you access to these models.

---

## How it works

SquadCoder Zen works like any other provider in SquadCoder.

1. You sign in to **<a href={console}>SquadCoder Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select SquadCoder Zen, and paste your API key.
...
The [model id](/docs/config/#models) in your SquadCoder config
...
- MiniMax M2.5 Free is available on SquadCoder for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Super Free is available on SquadCoder for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on SquadCoder for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with SquadCoder as well.

...
export function parsePath(absPath: string): MemoryLocator | null {
  // SQUADCODER(#908/#861): reconcile builds paths with path.join -> backslashes on Windows, and the
...
export function parseCcPath(absPath: string): MemoryLocator | null {
  // SQUADCODER(#908/#861): normalize Windows backslashes before matching (see parsePath).

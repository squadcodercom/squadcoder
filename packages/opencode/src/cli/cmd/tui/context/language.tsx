...
import { I18nProvider } from "@squadcoder/ui/context/i18n"
...
const loaders: Record<Exclude<Locale, "en">, () => Promise<Dictionary>> = {
  zh: () => merge(import("@squadcoder/ui/i18n/zh"), import("../i18n/zh")),
  zht: () => merge(import("@squadcoder/ui/i18n/zht"), import("../i18n/zht")),
  ko: () => merge(import("@squadcoder/ui/i18n/ko")),
  de: () => merge(import("@squadcoder/ui/i18n/de")),
  es: () => merge(import("@squadcoder/ui/i18n/es"), import("../i18n/es")),
  fr: () => merge(import("@squadcoder/ui/i18n/fr"), import("../i18n/fr")),
  da: () => merge(import("@squadcoder/ui/i18n/da")),
  ja: () => merge(import("@squadcoder/ui/i18n/ja"), import("../i18n/ja")),
  pl: () => merge(import("@squadcoder/ui/i18n/pl")),
  ru: () => merge(import("@squadcoder/ui/i18n/ru"), import("../i18n/ru")),
  ar: () => merge(import("@squadcoder/ui/i18n/ar")),
  he: () => merge(import("@squadcoder/ui/i18n/he"), import("../i18n/he")),
  no: () => merge(import("@squadcoder/ui/i18n/no")),
  br: () => merge(import("@squadcoder/ui/i18n/br")),
  th: () => merge(import("@squadcoder/ui/i18n/th")),
  bs: () => merge(import("@squadcoder/ui/i18n/bs")),
  tr: () => merge(import("@squadcoder/ui/i18n/tr")),
}

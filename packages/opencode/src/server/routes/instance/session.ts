  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all SquadCoder sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific SquadCoder session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new SquadCoder session for interacting with AI assistants and managing conversations.",

import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@squadcoder/sdk/v2/client"
...
import { List, type ListRef } from "@squadcoder/ui/list"
...
export function DialogConnectProvider(props: { provider: string }) {
  ...
  async function complete() {
    ...
    // Optimistically mark the provider connected across global + project stores so the Providers list
    // updates immediately (useProviders reads the per-directory store inside a project).
    globalSync.setProviderConnected(props.provider, true)
    dialog.close()
    showToast({
      variant: "success",
      icon: "circle-check",

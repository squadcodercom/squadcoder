export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez SquadCoder",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w SquadCoder.",
  ...
  "provider.connect.opencodeZen.line1":
    "SquadCoder Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w SquadCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w SquadCoder.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w squadcoder.json",
  ...
  "dialog.server.description": "Przełącz serwer SquadCoder, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja SquadCoder ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu SquadCoder",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (squadcoder.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.title": "Witamy w SquadCoder",
  "sidebar.gettingStarted.line1": "Twój asystent kodowania AI tworzony z myślą o RTL/hebrajskim w pierwszej kolejności.",
  "sidebar.gettingStarted.line2": "Połącz dostawcę (Claude, GPT, Gemini, OpenRouter…), aby dodać pierwszy model. W każdej chwili możesz dodać kolejne za pomocą +, albo pominąć na razie.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla SquadCoder",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd SquadCoder na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy SquadCoder ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw SquadCoder.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania SquadCoder",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji SquadCoder.",

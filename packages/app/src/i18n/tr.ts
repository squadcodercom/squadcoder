...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "SquadCoder tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve SquadCoder'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "SquadCoder Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve SquadCoder'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak SquadCoder'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler squadcoder.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi SquadCoder sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "SquadCoder'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı SquadCoder ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (squadcoder.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: SquadCoder henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.title": "SquadCoder'a hoş geldiniz",
  "sidebar.gettingStarted.line1": "RTL/İbranice öncelikli yapay zeka kodlama asistanınız.",
  "sidebar.gettingStarted.line2": "İlk modelinizi eklemek için bir sağlayıcı (Claude, GPT, Gemini, OpenRouter…) bağlayın. İstediğiniz zaman + ile daha fazlasını ekleyebilir veya şimdilik atlayabilirsiniz.",
  ...
  "app.name.desktop": "SquadCoder Masaüstü",
  ...
  "settings.desktop.wsl.description": "SquadCoder sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "SquadCoder'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "SquadCoder'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "SquadCoder'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "SquadCoder'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "SquadCoder başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "SquadCoder'un en son sürümünü kullanıyorsunuz.",

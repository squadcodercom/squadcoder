...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av SquadCoder",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i SquadCoder.",
  ...
  "provider.connect.opencodeZen.line1":
    "SquadCoder Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i SquadCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i SquadCoder.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i squadcoder.json",
  ...
  "dialog.server.description": "Bytt hvilken SquadCoder-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av SquadCoder ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (squadcoder.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at SquadCoder ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line2": "Koble til en leverandør (Claude, GPT, Gemini, OpenRouter…) for å legge til din første modell. Du kan legge til flere når som helst med +, eller hoppe over for nå.",
  ...
  "settings.desktop.wsl.description": "Kjør SquadCoder-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for SquadCoder",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan SquadCoder ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om SquadCoder skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan SquadCoder er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når SquadCoder starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av SquadCoder.",

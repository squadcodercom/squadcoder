export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje SquadCoder",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u SquadCoder-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "SquadCoder Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u SquadCoder-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u SquadCoder-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u squadcoder.json",
  ...
  "dialog.server.description": "Promijeni na koji se SquadCoder server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija SquadCoder-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (squadcoder.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: SquadCoder još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.title": "Dobrodošli u SquadCoder",
  "sidebar.gettingStarted.line1": "Vaš AI asistent za kodiranje — prvenstveno za RTL/hebrejski.",
  "sidebar.gettingStarted.line2": "Povežite provajdera (Claude, GPT, Gemini, OpenRouter…) da dodate svoj prvi model. Možete dodati još u bilo kojem trenutku pomoću +, ili preskočiti za sada.",
  ...
  "settings.desktop.wsl.description": "Pokreni SquadCoder server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u SquadCoder-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako SquadCoder izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li SquadCoder prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu SquadCoder-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se SquadCoder pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju SquadCoder-a.",

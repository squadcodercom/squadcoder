export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "SquadCoderが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、SquadCoderで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "SquadCoder Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してSquadCoderで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、SquadCoderで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "squadcoder.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するSquadCoderサーバーを切り替えます。",
  ...
  "toast.update.description": "SquadCoderの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをSquadCoderチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (squadcoder.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: SquadCoderはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.title": "SquadCoderへようこそ",
  "sidebar.gettingStarted.line1": "RTL・ヘブライ語ファーストのAIコーディングアシスタントです。",
  "sidebar.gettingStarted.line2": "プロバイダー（Claude、GPT、Gemini、OpenRouter…）を接続して、最初のモデルを追加しましょう。+ ボタンでいつでも追加でき、今はスキップすることもできます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でSquadCoderサーバーを実行します。",
  ...
  "settings.general.row.language.description": "SquadCoderの表示言語を変更します",
  "settings.general.row.appearance.title": "外観",
  "settings.general.row.appearance.description": "デバイスでのSquadCoderの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "SquadCoderがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "SquadCoderのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "SquadCoder の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "SquadCoder は最新バージョンです。",

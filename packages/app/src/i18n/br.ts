export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo SquadCoder",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no SquadCoder.",
  ...
  "provider.connect.opencodeZen.line1":
    "SquadCoder Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no SquadCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no SquadCoder.",
  ...
  "dialog.plugins.empty": "Plugins configurados em squadcoder.json",
  ...
  "dialog.server.description": "Trocar para qual servidor SquadCoder este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do SquadCoder ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do SquadCoder",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (squadcoder.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: SquadCoder ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.title": "Bem-vindo ao SquadCoder",
  "sidebar.gettingStarted.line1": "Seu assistente de programação com IA, pensado primeiro para RTL/hebraico.",
  "sidebar.gettingStarted.line2": "Conecte um provedor (Claude, GPT, Gemini, OpenRouter…) para adicionar seu primeiro modelo. Você pode adicionar mais a qualquer momento com +, ou pular por enquanto.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor SquadCoder dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do SquadCoder",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o SquadCoder aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o SquadCoder segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o SquadCoder é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o SquadCoder iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do SquadCoder.",

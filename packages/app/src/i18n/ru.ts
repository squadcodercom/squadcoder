export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от SquadCoder",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в SquadCoder.",
  ...
  "provider.connect.opencodeZen.line1":
    "SquadCoder Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в SquadCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в SquadCoder.",
  ...
  "dialog.plugins.empty": "Плагины настроены в squadcoder.json",
  ...
  "dialog.server.description": "Переключите сервер SquadCoder к которому подключается приложение.",
  ...
  "toast.update.description": "Новая версия SquadCoder ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде SquadCoder",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (squadcoder.json)",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что SquadCoder пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.title": "Добро пожаловать в SquadCoder",
  "sidebar.gettingStarted.line1": "Ваш ИИ-ассистент для программирования с приоритетом RTL и иврита.",
  "sidebar.gettingStarted.line2":
    "Подключите провайдера (Claude, GPT, Gemini, OpenRouter…), чтобы добавить первую модель. Вы можете добавить ещё в любой момент с помощью +, или пока пропустить.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер SquadCoder внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения SquadCoder",
  "settings.general.row.appearance.title": "Внешний вид",
  "settings.general.row.appearance.description": "Настройте как SquadCoder выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли SquadCoder системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление SquadCoder.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске SquadCoder",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию SquadCoder.",

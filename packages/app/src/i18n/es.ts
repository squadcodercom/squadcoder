export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por SquadCoder",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en SquadCoder.",
  ...
  "provider.connect.opencodeZen.line1":
    "SquadCoder Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en SquadCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en SquadCoder.",
  ...
  "dialog.plugins.empty": "Plugins configurados en squadcoder.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de SquadCoder se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de SquadCoder ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de SquadCoder",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (squadcoder.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, SquadCoder no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.title": "Te damos la bienvenida a SquadCoder",
  "sidebar.gettingStarted.line1": "Tu asistente de programación con IA, diseñado primero para RTL/hebreo.",
  "sidebar.gettingStarted.line2": "Conecta un proveedor (Claude, GPT, Gemini, OpenRouter…) para añadir tu primer modelo. Puedes añadir más en cualquier momento con +, u omitir por ahora.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor SquadCoder dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para SquadCoder",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve SquadCoder en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si SquadCoder sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de SquadCoder.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia SquadCoder",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de SquadCoder.",

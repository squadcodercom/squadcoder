export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من SquadCoder",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في SquadCoder.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك SquadCoder Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في SquadCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في SquadCoder.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في squadcoder.json",
  ...
  "dialog.server.description": "تبديل خادم SquadCoder الذي يتصل به هذا التطبيق.",
  ...
  "toast.update.description": "نسخة جديدة من SquadCoder ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (squadcoder.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن SquadCoder لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.title": "مرحبًا بك في SquadCoder",
  "sidebar.gettingStarted.line1": "مساعد البرمجة بالذكاء الاصطناعي المصمَّم أولًا للعبرية والكتابة من اليمين إلى اليسار.",
  "sidebar.gettingStarted.line2": "قم بتوصيل موفّر (Claude أو GPT أو Gemini أو OpenRouter…) لإضافة نموذجك الأول. يمكنك إضافة المزيد في أي وقت باستخدام +، أو التخطّي الآن.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم SquadCoder داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ SquadCoder",
  "settings.general.row.appearance.title": "المظهر",
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور SquadCoder على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان SquadCoder يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة SquadCoder.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل SquadCoder",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من SquadCoder.",

export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af SquadCoder",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i SquadCoder.",
  ...
  "provider.connect.opencodeZen.line1":
    "SquadCoder Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i SquadCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i SquadCoder.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i squadcoder.json",
  ...
  "dialog.server.description": "Skift hvilken SquadCoder-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af SquadCoder ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til SquadCoder-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (squadcoder.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, SquadCoder understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.title": "Velkommen til SquadCoder",
  "sidebar.gettingStarted.line1": "Din RTL/hebraisk-først AI-kodeassistent.",
  "sidebar.gettingStarted.line2": "Forbind en udbyder (Claude, GPT, Gemini, OpenRouter…) for at tilføje din første model. Du kan altid tilføje flere med +, eller springe over for nu.",
  ...
  "settings.desktop.wsl.description": "Kør SquadCoder-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for SquadCoder",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan SquadCoder ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om SquadCoder følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan SquadCoder er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når SquadCoder starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af SquadCoder.",

export const dict = {
  ...
  "agent.mode.desc.build": "Default coding agent — writes, edits, and runs code with the full toolset.",
  "agent.mode.desc.plan": "Read-only planning — explores and designs an approach without changing files.",
  "agent.mode.desc.compose": "Routes your task to the right skill (brainstorm, debug, TDD, review, verify…).",
  "agent.mode.desc.audit": "Reviews code and security for issues — read-only, makes no changes.",
  "agent.mode.desc.design": "UI/UX pass using the bundled design + Hebrew/RTL skills.",
  "agent.mode.desc.team": "Runs a full engineering org — a Team Lead fires Product/Architect/Dev/UI/Security/QA subagents in parallel and coordinates them. Best for non-trivial features or audits.",
  ...
  "command.workspace.docs": "Workspace docs",
  "command.workspace.docs.description": "Browse CLAUDE.md, AGENTS.md, memory and skill docs",
  "command.workspace.groupSessions.description": "Toggle date grouping (Today / Yesterday / …) in the session list",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by SquadCoder",
  ...
  "provider.connect.method.apiKey": "API key (recommended)",
  "provider.connect.method.claudeProMax": "Claude Pro/Max subscription (⚠️ at your own risk)",
  "provider.connect.remoteWarning.title": "Heads up: tokens are stored on the remote host",
  "provider.connect.remoteWarning.body": "On a remote (SSH) server your login tokens are saved on that host. Avoid connecting on a shared or untrusted machine.",
  "provider.connect.remoteWarning.dismiss": "Got it",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in SquadCoder.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "SquadCoder Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in SquadCoder.",
  ...
  "dialog.workspaceDocs.title": "Workspace docs",
  "dialog.workspaceDocs.openExternal": "Open in editor",
  "dialog.workspaceDocs.empty": "No .md files found in this workspace",
  "dialog.workspaceDocs.selectPrompt": "Select a document to view",
  "dialog.workspaceDocs.loading": "Loading document…",
  "dialog.workspaceDocs.loadError": "Couldn't load this document. It may have been moved or you may not have access.",
  "dialog.workspaceDocs.fileEmpty": "This document is empty.",
  ...
  "dialog.server.description": "Switch which SquadCoder server this app connects to.",
  ...
  "server.ssh.import.label": "Import from your SSH config",
  "server.ssh.import.placeholder": "Pick a host from ~/.ssh/config…",
  "server.ssh.field.host": "Host",
  "server.ssh.field.hostPlaceholder": "example.com or 10.0.0.5",
  "server.ssh.field.user": "User",
  "server.ssh.field.userPlaceholder": "e.g. ubuntu",
  "server.ssh.field.port": "Port",
  "server.ssh.field.keyFile": "SSH key file",
  "server.ssh.field.keyFilePlaceholder": "~/.ssh/id_ed25519",
  "server.ssh.field.keyFileBrowse": "Browse…",
  "server.ssh.field.remotePort": "Remote engine port",
  "server.ssh.auth.label": "Login",
  "server.ssh.auth.agent": "ssh-agent",
  "server.ssh.auth.key": "Key file",
  "server.ssh.connect": "Connect",
  "server.ssh.connecting": "Connecting…",
  "server.ssh.disconnect": "Disconnect",
  "server.ssh.help": "SquadCoder opens an SSH tunnel and starts its engine on the remote host. Key-based login (ssh-agent or a private key file) is recommended — the engine stays bound to the remote's loopback.",
  "server.ssh.phase.connecting": "Connecting…",
  "server.ssh.phase.bootstrapping": "Starting engine on the remote…",
  "server.ssh.phase.openingTunnel": "Opening secure tunnel…",
  "server.ssh.phase.attached": "Connected",
  "server.ssh.error.missingFields": "Enter a host and a user.",
  "server.ssh.error.clientMissing":
    "OpenSSH client not found. Enable it in Windows ▸ Settings ▸ Apps ▸ Optional Features ▸ OpenSSH Client.",
  "server.ssh.error.authFailed": "Authentication failed. Check your key or ssh-agent.",
  "server.ssh.error.hostKeyChanged": "Host key changed — connection refused.",
  "server.ssh.error.forwardFailed": "Port forwarding failed on the remote host.",
  "server.ssh.error.engineNotInstalled": "SquadCoder is not installed on the remote host.",
  "server.ssh.error.engineFailed": "Could not start the engine on the remote host.",
  "server.ssh.error.timedOut": "Connection timed out.",
  ...
  "toast.update.description": "A new version of SquadCoder ({{version}}) is now available to install.",
  ...
  "error.file.empty": "Couldn't load this file (no content returned). Try reopening it.",
  ...
  "error.chain.checkConfig": "Check your config (squadcoder.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, SquadCoder does not support MCP authentication yet.',
  ...
  "usage.approaching": "Approaching your Claude usage limit — {{percent}}% of your {{window}} limit used",
  "usage.window.fiveHour": "5-hour",
  "usage.window.weekly": "weekly",
  "usage.resetsIn": "resets in {{time}}",
  "usage.reset.minutes": "{{count}} min",
  "usage.reset.hours": "{{count}} h",
  "usage.reset.days": "{{count}} d",
  "usage.dismiss": "Dismiss",
  "usage.viewDetails": "View usage",
  ...
  "onboarding.workspace.title": "Set up this workspace for the best results",
  "onboarding.workspace.subtitle": "A minute here gives every agent full context about your project.",
  "onboarding.workspace.init.title": "Describe your project —",
  "onboarding.workspace.init.body":
    "Run it once and the agents learn your stack, conventions and goals (creates an AGENTS.md the whole team reads).",
  "onboarding.workspace.notes.title": "Keep durable notes",
  "onboarding.workspace.notes.body":
    "Add decisions and context to AGENTS.md or memory — the team remembers them across every session.",
  "onboarding.workspace.skills.title": "Turn on the skills you need",
  "onboarding.workspace.skills.body":
    "Open Skills in the toolbar to enable Hebrew docs, UI/UX, ad-platforms and more — they auto-fire when relevant.",
  "onboarding.workspace.remote.title": "Developing locally, deploying to a server?",
  "onboarding.workspace.remote.body":
    "Connect your host in Settings → Remote to sync and run the agent directly on production.",
  "onboarding.workspace.dismiss": "Dismiss",
  "agents.active.count": "{{count}} agents working",
  "agents.active.title": "Working now",
  "agents.active.stopAll": "Stop all",
  ...
  "dialog.agents.chooseModel": "Choose model",
  "dialog.agentModel.title": "Model for {{agent}}",
  "dialog.agentModel.search": "Search models…",
  "dialog.agentModel.empty": "No models available",
  "status.popover.action.manageServers": "Manage servers",
  "status.popover.action.manageInSettings": "Manage in settings",

  "window.control.minimize": "Minimize",
  "window.control.maximize": "Maximize",
  "window.control.restore": "Restore",
  "window.control.close": "Close",
  ...
  "sidebar.sessions.group": "Group sessions by date",
  "sidebar.sessions.ungroup": "Ungroup sessions",
  "sidebar.sessionGroup.today": "Today",
  "sidebar.sessionGroup.yesterday": "Yesterday",
  "sidebar.sessionGroup.week": "Previous 7 days",
  "sidebar.sessionGroup.month": "Previous 30 days",
  "sidebar.sessionGroup.older": "Older",
  "sidebar.gettingStarted.title": "Welcome to SquadCoder",
  "sidebar.gettingStarted.line1": "Your RTL/Hebrew-first AI coding assistant.",
  "sidebar.gettingStarted.line2": "Connect a provider (Claude, GPT, Gemini, OpenRouter…) to add your first model. You can add more anytime with +, or skip for now.",
  ...
  "settings.agents.description": "Customize each agent's model, behavior and prompt.",
  "settings.agents.empty": "No agents found",
  "settings.agents.selectPrompt": "Select an agent to edit",
  "settings.agents.builtin": "Built-in",
  "settings.agents.disabled": "Disabled",
  "settings.agents.group.primary": "Primary",
  "settings.agents.group.team": "Team roles",
  "settings.agents.group.subagent": "Subagents",
  "settings.routines.title": "Routines",
  "settings.routines.description": "Run a saved routine (slash-command) on a schedule via your OS task scheduler.",
  "settings.routines.empty": "No routines found",
  "settings.routines.selectPrompt": "Select a routine to schedule",
  "settings.routines.frequency": "Frequency",
  "settings.routines.freq.daily": "Daily",
  "settings.routines.freq.weekly": "Weekly",
  "settings.routines.time": "Time",
  "settings.routines.weekday": "Day of week",
  "settings.routines.scheduled.daily": "Daily at {{time}}",
  "settings.routines.scheduled.weekly": "{{day}} at {{time}}",
  "settings.routines.securityNote":
    "Scheduled routines run unattended and automatically deny any action that needs permission (safe by default). Requires the squadcoder CLI on your PATH.",
  "settings.routines.save": "Save schedule",
  "settings.routines.remove": "Remove schedule",
  "settings.routines.saved": "Schedule saved",
  "settings.routines.failed": "Couldn't save the schedule",
  "settings.usage.title": "Usage",
  "settings.usage.description": "See which connections are active, and your usage where available.",
  "settings.usage.summary": "{{connected}} of {{total}} connected",
  "settings.usage.connected": "Connected",
  "settings.usage.notConnected": "Not connected",
  "settings.usage.noUsage": "No usage data available for this connection.",
  "settings.usage.fiveHour": "5-hour limit",
  "settings.usage.sevenDay": "Weekly limit",
  "settings.agents.field.enabled": "Enabled",
  "settings.agents.field.enabledHint": "Disabled agents are hidden from chat and @-mentions.",
  "settings.agents.field.mode": "Mode",
  "settings.agents.mode.primary": "Primary",
  "settings.agents.mode.subagent": "Subagent",
  "settings.agents.mode.all": "All",
  "settings.agents.field.model": "Model",
  "settings.agents.modelDefault": "Default model",
  "settings.agents.modelReset": "Reset",
  "settings.agents.field.temperature": "Temperature",
  "settings.agents.field.topP": "Top-P",
  "settings.agents.placeholder.temperature": "e.g. 0.7",
  "settings.agents.placeholder.topP": "e.g. 1.0",
  "settings.agents.field.description": "Description",
  "settings.agents.field.descriptionHint": "When this agent should be used.",
  "settings.agents.placeholder.description": "Describe when to use this agent",
  "settings.agents.field.prompt": "System prompt",
  "settings.agents.field.promptHint": "Extra system instructions appended for this agent.",
  "settings.agents.placeholder.prompt": "Additional instructions for this agent",
  "settings.agents.mergeNote":
    "Leave a field blank to keep its current value. Built-in and config agents are disabled, not deleted; removing file-based agents from disk comes in a later update.",
  "settings.agents.save": "Save changes",
  "settings.agents.saved": "Agent saved",

  "settings.skills.title": "Skills",
  "settings.skills.description": "Browse, enable and open the skills available to your agents.",
  "settings.skills.empty": "No skills found",
  "settings.skills.selectPrompt": "Select a skill to view",
  "settings.skills.enabled": "Enabled",
  "settings.skills.openFile": "Open file",
  "settings.skills.openFolder": "Open skills folder",
  "settings.skills.noContent": "This skill has no documented instructions.",
  ...
  "settings.skills.source.other": "Other",

  "settings.mcp.title": "MCP servers",
  "settings.mcp.description": "Connect Model Context Protocol tools and data sources.",
  "settings.mcp.empty": "No MCP servers configured",
  "settings.mcp.selectPrompt": "Select a server to edit",
  "settings.mcp.add": "Add server",
  "settings.mcp.import": "Import JSON",
  "settings.mcp.importHint": "Paste a Claude Desktop / mcpServers JSON snippet.",
  "settings.mcp.importApply": "Import",
  "settings.mcp.importEmpty": "No servers found in the pasted JSON",
  "settings.mcp.imported": "Imported {{count}} server(s)",
  "settings.mcp.field.name": "Name",
  "settings.mcp.placeholder.name": "my-server",
  "settings.mcp.field.transport": "Transport",
  "settings.mcp.transport.local": "Local",
  "settings.mcp.transport.remote": "Remote",
  "settings.mcp.field.command": "Command",
  "settings.mcp.field.env": "Environment",
  "settings.mcp.field.envHint": "One KEY=VALUE per line.",
  "settings.mcp.field.url": "URL",
  "settings.mcp.field.headers": "Headers",
  "settings.mcp.field.headersHint": "One Header: value per line.",
  "settings.mcp.field.enabled": "Enabled",
  "settings.mcp.field.enabledHint": "Connect this server on startup.",
  "settings.mcp.mergeNote": "Removing a server disables it; deleting it from config comes in a later update.",
  "settings.mcp.connect": "Connect",
  "settings.mcp.disconnect": "Disconnect",
  "settings.mcp.remove": "Remove",
  "settings.mcp.saved": "Server saved",
  "settings.mcp.removed": "Server removed",

  "settings.plugins.title": "Plugins",
  "settings.plugins.description": "Extend SquadCoder with plugins declared in your config.",
  "settings.plugins.empty": "No plugins declared",
  "settings.plugins.add": "Add",
  "settings.plugins.addPlaceholder": "npm package or path (e.g. my-plugin@1.0.0)",
  "settings.plugins.remove": "Remove",
  "settings.plugins.added": "Plugin added",
  "settings.plugins.removed": "Plugin removed",
  "settings.plugins.note": "Plugins auto-discovered from the .squadcoder/plugin folder load automatically and aren't listed here.",

  "settings.remote.title": "Remote",
  "settings.remote.description": "Connect to a SquadCoder server over SSH or HTTP and switch between machines.",
  "settings.remote.empty": "No servers configured",
  "settings.remote.add": "Add server",
  "settings.remote.active": "Active",
  "settings.remote.remove": "Remove",
  "settings.remote.note": "Remote SSH setup (key/password, Tailscale) is configured in the Add server flow.",


  "settings.indexing.title": "Indexing",
  "settings.indexing.description": "A local semantic index of your code. Agents search it with the codebase_search tool to find relevant files by meaning — like Cursor. Runs fully offline.",
  "settings.indexing.status.building": "Indexing…",
  "settings.indexing.status.ready": "Index ready",
  "settings.indexing.status.empty": "Not indexed yet",
  "settings.indexing.buildingDetail": "{{indexed}} / {{total}} files",
  "settings.indexing.summary": "{{files}} files · {{chunks}} code chunks indexed",
  "settings.indexing.fileCount": "{{count}} files mapped",
  "settings.indexing.reindex": "Re-index now",
  "settings.indexing.note": "Runs fully offline with a bundled embedding model. The agent calls codebase_search automatically to pull the most relevant code into context during a task.",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL integration",
  "settings.desktop.wsl.description": "Run the SquadCoder server inside WSL on Windows.",
  ...
  "settings.general.row.appearance.description": "Customise how SquadCoder looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether SquadCoder follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how SquadCoder is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when SquadCoder launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of SquadCoder.",

import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@squadcoder/sdk/v2"
import { SessionTurn } from "@squadcoder/ui/session-turn"
import { SessionReview } from "@squadcoder/ui/session-review"
import { DataProvider } from "@squadcoder/ui/context"
import { FileComponentProvider } from "@squadcoder/ui/context/file"
import { WorkerPoolProvider } from "@squadcoder/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@squadcoder/ui/logo"
import { IconButton } from "@squadcoder/ui/icon-button"
import { ProviderIcon } from "@squadcoder/ui/provider-icon"
import { iife } from "@squadcoder/shared/util/iife"
import { Binary } from "@squadcoder/shared/util/binary"
...
import { MessageNav } from "@squadcoder/ui/message-nav"
import { FileSSR } from "@squadcoder/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@squadcoder/ui/pierre/worker").then((m) => ({
          ...
          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | SquadCoder</Title>
              </Show>

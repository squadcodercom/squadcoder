export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von SquadCoder",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von SquadCoder wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",

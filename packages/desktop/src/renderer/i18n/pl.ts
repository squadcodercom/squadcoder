export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji SquadCoder",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} SquadCoder. Czy chcesz ją zainstalować i uruchomić ponownie?",

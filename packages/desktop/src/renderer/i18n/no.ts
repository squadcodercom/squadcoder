export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av SquadCoder",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av SquadCoder er lastet ned. Vil du installere den og starte på nytt?",

export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af SquadCoder",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af SquadCoder er blevet downloadet. Vil du installere den og genstarte?",

export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من SquadCoder",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من SquadCoder، هل ترغب في تثبيته وإعادة تشغيله؟",

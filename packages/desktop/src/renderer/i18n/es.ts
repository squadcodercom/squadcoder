export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de SquadCoder",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de SquadCoder. ¿Quieres instalarla y reiniciar?",

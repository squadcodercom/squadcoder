export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju SquadCoder-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} SquadCoder-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",

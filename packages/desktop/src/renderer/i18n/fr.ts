export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'SquadCoder",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'SquadCoder a été téléchargée. Voulez-vous l'installer et redémarrer ?",

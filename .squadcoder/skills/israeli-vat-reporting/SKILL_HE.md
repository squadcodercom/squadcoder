...
2. דרישות מע"מ תשומות נתמכות בחשבוניות מס תקפות עם מספר הקצאה, חובה מעל סף עסקה (לפני מע"מ) שיורד בשלבים: 25,000 ש"ח (ממאי 2024), 20,000 ש"ח (מינואר 2025), 10,000 ש"ח (מינואר 2026, בתוקף כעת), 5,000 ש"ח (מ-1 ביוני 2026). תמיד בדקו את הסף שהיה בתוקף בתאריך החשבונית

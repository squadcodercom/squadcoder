...
license: MIT
compatibility: Requires openpyxl for Excel generation (Google Sheets needs no install). Works with Claude Code, Cursor, GitHub Copilot, Windsurf, SquadCoder, Codex, Antigravity, Gemini CLI.
---

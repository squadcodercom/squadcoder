...
compatibility: Works with Claude Code, Cursor, GitHub Copilot, Windsurf, SquadCoder, Codex, OpenClaw, Antigravity, Gemini CLI. OpenClaw recommended for scheduled price monitoring and multi-platform inventory sync.
---
